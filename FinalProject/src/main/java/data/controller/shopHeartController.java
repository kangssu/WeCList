...
public class shopHeartController {
  ...
  public void insert(@ModelAttribute ShopHeartDto dto, @RequestParam String shop_heart,
  ...
  public void delete(String shop_heart, @RequestParam(required = false) int num,
      HttpSession session) {
