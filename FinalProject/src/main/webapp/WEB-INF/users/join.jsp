			...
			<form action="#">		
				...
				<table class="view_buy_form_1">
					<tr class="checkout__input">
						<td>아이디</td>
						<td>
							<input type="text" placeholder="6자 이상의 영문 혹은 영문과 숫자를 조합" class="checkout__input__add">
							<button type="button" class="addr-btn" onclick="location.href='buy'">중복확인</button><br>
							<p id="id_check">
								<i class="fa fa-hand-o-right" aria-hidden="true" style="font-size:13px; margin-right:5px"></i>
								<span style="font-size:13px; color:#6f6f6f">6자 이상의 영문 혹은 영문과 숫자를 조합</span><br>
								<i class="fa fa-hand-o-right" aria-hidden="true" style="font-size:13px; margin-right:5px"></i>
					...
					<tr class="checkout__input">
						<td>비밀번호</td>
						<td>
							<input type="text" placeholder="비밀번호를 입력해주세요." class="checkout__input__add">
							<p id="pw_check1">
								<i class="fa fa-hand-o-right" aria-hidden="true" style="font-size:13px; margin-right:5px"></i>
								<span style="font-size:13px; color:#6f6f6f">10자 이상 입력</span><br>
								<i class="fa fa-hand-o-right" aria-hidden="true" style="font-size:13px; margin-right:5px"></i>
								<span style="font-size:13px; color:#6f6f6f">영문/숫자/특수문자(공백 제외)만 허용하며, 2개 이상 조합</span><br>
								<i class="fa fa-hand-o-right" aria-hidden="true" style="font-size:13px; margin-right:5px"></i>
					...
					<tr class="checkout__input">
						<td>비밀번호 확인</td>
						<td>
							<input type="text" placeholder="비밀번호를 한번 더 입력해주세요." class="checkout__input__add">
							<p id="pw_check2">
								<i class="fa fa-hand-o-right" aria-hidden="true" style="font-size:13px; margin-right:5px"></i>
					...
					<tr class="checkout__input">
						<td>이메일</td>
						<td>
							<input type="text" placeholder="본인 이메일을 작성해주세요. 예: weclist@weclist.com" class="checkout__input__add">
							<button type="button" class="addr-btn" onclick="location.href='buy'">중복확인</button>
						</td>
					</tr>
					<tr class="checkout__input">
						<td>휴대폰</td>
					...
					<tr class="checkout__input">
						<td>주소</td>
						<td>
							<input type="text" placeholder="택배를 받을 주소를 입력해주세요." class="checkout__input__add">
							<button type="button" class="addr-btn" onclick="location.href='buy'">주소찾기</button></td>
					</tr>
					<tr class="checkout__input">
						<td>상세 주소</td>
