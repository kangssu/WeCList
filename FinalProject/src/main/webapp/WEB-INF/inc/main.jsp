		...
		<div class="row">
			<div class="col-lg-12">
				<div class="section-title">
					<h2>인기 작품</h2>
					<span>WE C LIST만의 인기 작품을 구경해보세요!</span>
				</div>
				<div class="featured__controls">
					<ul>
						<li class="active" data-filter="*">전체보기</li>
						<li data-filter=".oranges">식품</li>
						<li data-filter=".fresh-meat">공예</li>
						<li data-filter=".vegetables">생활용품</li>
					</ul>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="section-title from-blog__title">
					<h2>작가 스토리</h2>
					<span>WE C LIST의 작가 스토리를 구경해보세요!</span>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-lg-4 col-md-4 col-sm-6">
				<div class="blog__item">
					<div class="blog__item__pic">
						<img src="img/blog/main_con3.jpg" alt="">
					</div>
