...
<div class="mypage__story">
	...
	<div class="mypage__story__form">
		<form action="/mypage/class/update" method="post"
			  enctype="multipart/form-data">
			<input type="hidden" name="myid" value="kang" /> <input
			...
			<table class="story__table__form">
				...
				<tr>
					...
					<td colspan="3"><textarea id="summernote2"
											  name="class_process">${dto.class_process}</textarea></td>
				</tr>
				<tr>
					<th>사진</th>
				...
				<tr>
					...
					<td colspan="3"><textarea id="summernote3"
											  name="class_refund">${dto.class_refund}</textarea></td>
				</tr>
