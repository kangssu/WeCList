		...
		<form action="/mypage/class/update" method="post" enctype="multipart/form-data">
			...
			<table class="story__table__form">
				<tr>
					<th>제목</th>
					<td colspan="3">
						<input type="text" name="title" value="${dto.title}"></input>
					</td>
				</tr>
				<tr>
					<th>간략 소개</th>
					<td colspan="3">
						<input type="text" name="classsub" value="${dto.classsub}"></input>
					</td>
				</tr>
				<tr>
					<th>옵 션</th>
				...
				<tr>
					<th>가 격</th>
					<td colspan="3">
						<input type="text" name="classprice" required="required" autofocus="autofocus" value="${dto.classprice}">
					</td>
				</tr>
				<tr>
					<th>클래스 소개</th>
					<td colspan="3">
						<textarea id="summernote1" name="classinfo">${dto.classinfo}</textarea>
					</td>
				</tr>
				<tr>
					<th>진행 과정</th>
					<td colspan="3">
						<textarea id="summernote2" name="class_process">${dto.class_process}</textarea>
					</td>
				</tr>
				<tr>
					<th>사진</th>
				...
				<tr>
					<th>환불 정책</th>
					<td colspan="3">
						<textarea id="summernote3" name="class_refund">${dto.class_refund}</textarea>
					</td>
				</tr>
