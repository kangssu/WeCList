	...
	<div class="mypage__profile">
		...
		<div class="mypage__profile__form">
			<table class="profile__form__table">
				...
				<tr>
					<td><textarea name="history" required="required"
							placeholder="※ 작품만의 History를 자세히 적어주세요."></textarea>
						<div class="image__preview__all">
							<ul id="preview"></ul>
							<!-- 여기 안에 li로 image가 추가됨 -->
							<div class="preview__inp">
								<label class="input_file_btn" for="uploadFile"><i
									class="fa fa-plus" aria-hidden="true"></i></label> <input type="file"
									name="uploadFile" id="uploadFile" multiple maxlength="5" />
							</div>
						</div></td>
				</tr>
				<tr>
				...
				<tr>
					<td><textarea name="idea" required="required"
				...
				<tr>
					<td><textarea name="identity" required="required"
