...
* 해당 사이트를 제작한 이유는 일반적인 쇼핑몰이 아닌 정성이 들어간 상품을 판매하는 쇼핑몰을 만들어보고 싶었습니다.<br/>
* 그 이유는 저희도 웹사이트를 무에서 유로 만드는 것처럼 저희가 만드는 웹사이트 내에서도 많은 손재주를 가진 사람들이<br/>
  직접 만든 상품을 판매하면서 활동하여 값진 경험을 위시리스트에서 차곡차곡 쌓아가길 바랬습니다.
* 웹사이트를 만들고 싶은 목적이랑 가장 적합한 웹사이트가 idus 였고, 해당 웹사이트를 벤치하였습니다.
<br/>
